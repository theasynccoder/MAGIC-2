...
class MedicalDocParser:
    ...
    def parse_document_fallback(self, document_path: str) -> str:
        """
        Fallback parser that extracts plain text from PDF without Docling models.
        Useful on Windows environments where model cache symlinks can fail.
        """
        try:
